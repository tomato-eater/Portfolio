...
export const profile:Profile = {
    ...
    bio: "私は、自ら進んで挑戦できることが強みです。\n学校ではプログラムを主に勉強していましたが、ゲーム制作をする際に3DCGも触れる方が良いと考え、独学でBlenderでモデリングしてみたり、MayaやZbrashを教わったりしました。\n最初は思い通りのオブジェクトを作製することが出来なかったのですが、先生に「作成したい物の構成を理解すると良い」と助言を頂き、作製したい物の類似品を調べたり観察をして理解度を高めました。\nその結果、ゲーム制作などで自分が必要と感じたオブジェクトを自分で作製できるようになり、3Dモデルの理解度やモチベーションを上げることが出来ました。\nこの「目新しいことでも挑戦して、吸収し、楽しめること」を活かし、御社でも挑戦することを恐れず様々な知識や技術を入手し、様々な面で貢献できると考えています。",
